...
public class AppTest {
    ...
    {
        PropertyConfigurator.configure("C:\\Users\\ilama\\Downloads\\Model\\Model\\holidayresort\\sec\\src\\main\\resources\\log4j2.properties");
        WebDriverManager.chromedriver().setup();
        driver = new ChromeDriver();
        driver.manage().window().maximize();
        driver.get("https://www.puriholidayresort.com/");
    ...
    {
        PropertyConfigurator.configure("C:\\Users\\ilama\\Downloads\\Model\\Model\\holidayresort\\seclog\\log4j2.properties");
        WebDriverManager.chromedriver().setup();
        driver = new ChromeDriver();
        driver.manage().window().maximize();
        driver.get("https://www.puriholidayresort.com/");
